  ...
  return (
    <div className={`relative w-full h-screen overflow-hidden bg-black ${className}`}>
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-white">
        ...
        {/* Trust Badge */}
        {trustBadge && (
          <div className="mb-8 animate-helix-fade-down">
        ...
        <div className="text-center space-y-6 max-w-5xl mx-auto px-4">
          ...
          <div className="space-y-2">
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold bg-gradient-to-r from-orange-300 via-yellow-400 to-amber-300 bg-clip-text text-transparent animate-helix-fade-up [animation-delay:200ms]">
              {headline.line1}
            </h1>
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold bg-gradient-to-r from-yellow-300 via-orange-400 to-red-400 bg-clip-text text-transparent animate-helix-fade-up [animation-delay:400ms]">
              {headline.line2}
            </h1>
          </div>

          {/* Subtitle */}
          <div className="max-w-3xl mx-auto animate-helix-fade-up [animation-delay:600ms]">
          ...
          {/* Buttons */}
          {buttons && (
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10 animate-helix-fade-up [animation-delay:800ms]">
              {buttons.primary && (
                <button
